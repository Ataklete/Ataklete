...
/**
 *  This version of MyFrame uses an anonymous inner class as a listener
 *
 */
public class MyFrameAnonymous extends JFrame {
	...
	public MyFrameAnonymous(){
		...
		//Registering an ActionListener with button using an anonymous inner class
	...
	public static void main(String[] args) {
		...
		{
			public void run() {
				MyFrameAnonymous mf = new MyFrameAnonymous();
				mf.setVisible(true);
			}
		});
	}
