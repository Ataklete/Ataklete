...
public class Main {
	...
	private static void testEquals2() {
		...
		arr[1] = new Manager("Steve", 95000, 2019, 9, 12);
		arr[2] = new Employee("Dave", 105000);
		Employee bob = new Employee("Bob", 85000);
		Employee steve = new Employee("Steve", 95000);
		System.out.println("Is bob in the array? " + objectInArray(arr, bob));
		System.out.println("Is steve in the array? " + objectInArray(arr, steve));
	}
