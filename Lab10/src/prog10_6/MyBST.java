 ...
 */
public class MyBST implements PriorityQueue {
	private Node root;
	...
	public List<String> asList() {	
		return asList(new LinkedList<String>(), root);
	}
	...
	private List<String> asList(List<String> theList, Node t) {
	...
	private Node findNode(String val, Node n) {
		if(n == null) return null;
